...
const MemberAgreement = () => {
  ...
  // ===== 체크박스 핸들러 =====
  const toggleCheck = (name: 'all' | 'member' | 'person') => {
    if (name === 'all') {
  ...
  return (
    <div className="relative mx-auto box-border w-[500px] border border-borderLightColor p-[20px] laptop-lg:mb-[50px] laptop-lg:p-[25px]">
